...
> **[Chèn ảnh: Execute SQL Task "Update Lineage SUCCESS" - Cửa sổ cài đặt]**
...
> **[Chèn ảnh: OLE DB Source (Supplier) - SQL Query editor]**
...
> **[Chèn ảnh: OLE DB Command (Supplier) - Cửa sổ cài đặt với SET payment_days = NULL]**
...
> **[Chèn ảnh: Load_Fact_Sale.dtsx - Data Flow Task Designer - Luồng từ OLE DB Source → 4 Lookup components → Derived Column → OLE DB Destination]**
...
> **[Chèn ảnh: OLE DB Source (Fact) - Cửa sổ SQL Command editor cho Query bán hàng]**
...
> **[Chèn ảnh: Lookup component - Cửa sổ Lookup Table Tab, Reference Columns Tab, Columns Tab]**
...
> **[Chèn ảnh: Các Lookup component nối tiếp nhau - Hiển thị Data Flow path từ OLE DB Source đi qua 4 Lookups]**
...
> **[Chèn ảnh: Derived Column (Fact) - Expression Editor hiển thị các công thức tính toán metrics bán hàng]**
...
> **[Chèn ảnh: Load_Fact_Purchase.dtsx - Data Flow Task Designer - Luồng từ OLE DB Source → 3 Lookup components → Derived Column → OLE DB Destination]**
...
> **[Chèn ảnh: OLE DB Source (Purchase) - SQL Query editor]**
...
> **[Chèn ảnh: Derived Column (Purchase) - Expression Editor hiển thị các công thức tính toán metrics mua hàng]**
...
> **[Chèn ảnh: Load_Fact_Inventory.dtsx - Data Flow Task Designer - Luồng từ OLE DB Source (LEFT JOIN) → 4 Lookup components → Derived Column → OLE DB Destination]**
...
> **[Chèn ảnh: OLE DB Source (Inventory) - SQL Query với LEFT JOIN]**
...
> **[Chèn ảnh: Derived Column (Inventory) - Expression Editor hiển thị các công thức CASE WHEN cho quantity_in/quantity_out]**
...
## GHI CHÚ THÊM VỀ CẤU TRÚC ẢNH

Để hoàn thành báng cáo này, vui lòng chèn các ảnh minh họa tại các vị trí được đánh dấu. Các ảnh cần thiết:

1. **Control Flow chung** (1 ảnh): Toàn bộ 4 bước + nhánh lỗi
2. **Execute SQL Tasks** (3 ảnh): Insert START, Post-Processing, Update SUCCESS, Update FAILED
3. **Mỗi Load package** (8 ảnh): Load_Dim_Product, Load_Dim_Supplier, Load_Dim_Customer, Load_Dim_Employee, Load_Dim_City, Load_Fact_Sale, Load_Fact_Purchase, Load_Fact_Inventory
4. **Master_ETL** (1 ảnh): Package orchestration
5. **OLE DB Source** (4 ảnh): Dimension sources, Fact sources (Sale, Purchase, Inventory)
6. **OLE DB Command** (2 ảnh): Update Old Records, Update Inferred Members
7. **Slowly Changing Dimension** (1 ảnh): SCD component configuration
8. **Lookup components** (1 ảnh): Multiple lookups nối tiếp
9. **Derived Column** (3 ảnh): Dimension SCD columns, Fact metrics (Sales, Purchase, Inventory)
10. **Union All** (1 ảnh): Combining Historical và New outputs
11. **OLE DB Destination** (1 ảnh): Column mapping

**Tổng cộng: 26-28 ảnh minh họa**
